...
- **Бургер-меню** — анимированные 3 линии → крестик (верх/низ)
- **Верхняя модалка** — выпадающее меню от бургер-кнопки
- **Нижняя модалка** — панель с навигацией, категориями меню и контактами
- **Активная страница** — оранжевая полоска слева в обоих меню
- **Логотип** — на мобилках отображается только иконка чашки
- **Категории меню** — сворачиваемые с плавной анимацией
- **Карточки блюд** — кнопки и цены на одном уровне (flex)
- **Адаптивность** — бургер при 900px, нав-ссылки без переносов
...
| **USER** | Клиент | Просмотр меню, оформление заказов, бронирование, обратная связь, мобильная версия |
