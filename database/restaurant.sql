...
INSERT INTO dishes (category_id, name, description, price, weight, image) VALUES
    (6, 'Суши-сет', 'Набор из 8 видов суши и роллов с лососем, тунцом и креветкой', 950.00, 350, 'uploads/dishes/17-sushi.jpg'),
    (6, 'Холодец', 'Домашний холодец из говядины с хреном и горчицей', 350.00, 250, 'uploads/dishes/21-kholodets.jpg'),
    (6, 'Окрошка', 'Классическая окрошка на квасе с говядиной', 280.00, 300, 'uploads/dishes/22-okroshka.jpg');
