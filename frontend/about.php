<?php require_once __DIR__ . '/header.php'; ?>
    ...
    <section class="page-hero">
        <div class="container">
            ...
            <p>История, миссия и команда Точка Кипения</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="about-text fade-in">
                    ...
                    <p>Точка Кипения открыл свои двери в 2011 году. За 15 лет мы прошли путь от небольшого кафе до ресторана премиум-класса, завоевав признание гостей и профессиональные награды.</p>
    ...
    .faq-question { padding: 18px 24px; cursor: pointer; font-weight: 600; color: var(--color-text); display: flex; justify-content: space-between; align-items: center; background: var(--color-surface); transition: all 0.3s; }
