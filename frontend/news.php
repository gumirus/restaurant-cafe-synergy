...
$news = [
    [
        ...
        'img' => 'uploads/news/1-seasonal-menu.jpg',
    ],
    [
        'date' => '28 мая 2026',
        ...
        'img' => 'uploads/news/2-wine-tasting.jpg',
    ],
    [
        'date' => '15 мая 2026',
        'title' => 'Награда "Лучший ресторан года"',
        'text' => 'Точка Кипения признан лучшим рестораном Москвы по версии престижной премии.',
        'full' => 'Мы рады сообщить, что Точка Кипения признан лучшим рестораном Москвы по версии престижной ресторанной премии. Эта награда — результат труда всей нашей команды и любви наших гостей. Спасибо, что вы с нами!',
        'img' => 'uploads/news/3-masterclass.jpg',
    ],
    [
        'date' => '2 мая 2026',
    ...
    [
        ...
        'full' => 'С этого месяца мы начинаем работать с 8:00 утра! Для ранних пташек мы подготовили специальное утреннее меню завтраков, которое подаётся с 8:00 до 11:00. Кофе в подарок к каждому завтраку. Приходите начинать день с Точка Кипения!',
        'img' => 'uploads/news/1-seasonal-menu.jpg',
    ],
    [
        'date' => '10 апреля 2026',
        ...
        'img' => 'uploads/news/4-delivery.jpg',
    ],
];
?>
    ...
    <section class="page-hero">
        <div class="container">
            <h1>Новости</h1>
            <p>События и новинки ресторана Точка Кипения</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="news-grid">
                ...
                <article class="news-card fade-in">
                    <img class="clickable-img" src="<?= $item['img'] ?>" alt="<?= htmlspecialchars($item['title']) ?>">
    ...
    .modal-image { width: 100%; height: 250px; object-fit: cover; border-radius: 12px; margin-bottom: 20px; }
